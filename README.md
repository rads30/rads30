...
Implementing Data Mining using the Unsupervised learning method of Cluster analysis for pattern recognition and data insights.
...
- 🤖 Designed end-to-end workflow and architecture for AI chatbot systems
- 📊 Created real-time dashboards for critical project metrics analysis
...
---
⭐️ From [rads30](https://github.com/rads30) - Radhika
